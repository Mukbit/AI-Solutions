...
const Gallery = () => {
  ...
  return (
    <div>
            ...
            <div className="col-12 content-head">
              <div className="mbr-section-head mb-5">
                <h4 className="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                  <strong>Our Exciting Upcoming Events</strong>
                </h4>
              </div>
            </div>
          </div>
      ...
      <section data-bs-version="5.1" class="article15 cid-uuGhZ51dwe" id="about-us-15-uuGhZ51dwe">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-12 col-md">
              <h6 class="mbr-section-subtitle mbr-fonts-style mt-0 mb-4 display-5">
                <strong>AI-Solutions: Where Innovation Meets Imagination!</strong>
              </h6>
            </div>
            <div class="col-md-12 col-lg-6">
              <p class="mbr-text mbr-fonts-style display-7">
                Welcome to AI-Solutions, the Sunderland startup that’s shaking up the digital
                landscape! We specialize in AI-powered solutions that make work feel less like work.
              </p>
              <p class="mbr-text mbr-fonts-style display-7">
                Our mission? To enhance the digital employee experience with innovative virtual
                assistants and affordable prototyping that even your grandma could use!
              </p>
              <p class="mbr-text mbr-fonts-style display-7">
                We believe in a future where technology and creativity collide, making every
                workplace a hub of productivity and fun!
              </p>
            </div>
          </div>
        </div>
